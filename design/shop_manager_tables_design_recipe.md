...
items, name, unit_price, quantity, orders, customer_name, item, order_date
```
...
| orders                | customer_name, order_date, item
...
2. Name of the second table (always plural): `orders` 
    ...
    Column names: `customer_name`, `order_date`, `item`
...
psql -h 127.0.0.1 shop_manager < shop_manager_tables_seeds.sql
```
