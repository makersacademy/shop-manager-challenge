...
describe OrderRepository do
  ...
  it "Gets a list of all shop orders" do
    ...
    expect(orders[0].customer_name).to eq 'Aamir'
  ...
  it "Creates a new shop order" do
    repository = OrderRepository.new
    order = double :order, customer_name: 'Maya', date: '2022-08-07 13:00:00', item_id: 2
    ...
    expect(last_order.date).to eq '2022-08-07 13:00:00'
