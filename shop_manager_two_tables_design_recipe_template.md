# Shop Manager - Two Tables Design Recipe Template
...
shop items, item name, item unit price, item quantity, orders, customer name, order date
```
...
-> Therefore, the foreign key is on the item table.
```
